...
pixihx.demos = {};
pixihx.demos.snake = {};
pixihx.demos.snake.Main = function() {
...
pixihx.demos.snake.Main.main = function() {
	new pixihx.demos.snake.Main();
};
pixihx.demos.snake.Main.prototype = {
	animate: function() {
		window.requestAnimationFrame($bind(this,this.animate));
		this._count += 0.1;
		var length = 45.9;
...
pixihx.demos.snake.Main.main();
})();

//# sourceMappingURL=hx-pixi-snake.js.map