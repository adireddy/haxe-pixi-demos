...
var pixihx = {};
pixihx.demos = {};
pixihx.demos.pixidude = {};
pixihx.demos.pixidude.Main = function() {
...
pixihx.demos.pixidude.Main.main = function() {
	new pixihx.demos.pixidude.Main();
};
pixihx.demos.pixidude.Main.prototype = {
	animate: function() {
		window.requestAnimationFrame($bind(this,this.animate));
...
pixihx.demos.pixidude.Main.main();
})();

//# sourceMappingURL=hx-pixi-pixidude.js.map