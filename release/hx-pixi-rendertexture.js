...
var pixihx = {};
pixihx.demos = {};
pixihx.demos.rendertexture = {};
pixihx.demos.rendertexture.Main = function() {
...
pixihx.demos.rendertexture.Main.main = function() {
	new pixihx.demos.rendertexture.Main();
};
pixihx.demos.rendertexture.Main.prototype = {
	animate: function() {
		window.requestAnimationFrame($bind(this,this.animate));
		var _g1 = 0;
...
pixihx.demos.rendertexture.Main.main();
})();

//# sourceMappingURL=hx-pixi-rendertexture.js.map