...
pixihx.demos = {};
pixihx.demos.spine = {};
pixihx.demos.spine.Main = function() {
...
pixihx.demos.spine.Main.main = function() {
	new pixihx.demos.spine.Main();
};
pixihx.demos.spine.Main.prototype = {
	animate: function() {
		window.requestAnimationFrame($bind(this,this.animate));
...
pixihx.demos.spine.Main.main();
})();

//# sourceMappingURL=hx-pixi-spine.js.map