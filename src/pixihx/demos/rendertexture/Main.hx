package pixihx.demos.rendertexture;
...
class Main {
    ...
    private var _bunnyContainer:DisplayObjectContainer;
    private var _bunnys:Array<Dynamic>;

    private var _count1:Float;
    private var _score:Float;     
    private var _count2:Float;

    private var _renderTexture1:RenderTexture;
    private var _renderTexture2:RenderTexture;
    private var _currentTexture:RenderTexture;
